...
BEGIN
	IF (@codigo is null)
		BEGIN
			INSERT @table
			SELECT Medicamento.nome, Medicamento.lab_id, Lotes.quantidade, Lotes.validade, Medicamento.dose, Medicamento.categoria_id, Medicamento.tipo_id, Medicamento.codigo, Medicamento.PVP, Medicamento.Preco, Medicamento.IVA, NULL
